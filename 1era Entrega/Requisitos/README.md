...
Este directorio contiene los artefactos clave que definen y organizan las funcionalidades y restricciones del sistema.

| Documento | Descripción |
| :--- | :--- |
| [**Caso de Uso con Criterios de Aceptación.pdf**](https://github.com/jhoanapechram/-FIS-Equipo-2/blob/Primera-Entrega/1era%20Entrega/Requisitos/Caso%20de%20Uso%20con%20Criterios%20de%20Aceptación.pdf) | Detalla un caso de uso específico del sistema, incluyendo las condiciones que deben cumplirse para considerarlo funcional (Criterios de Aceptación). |
...
| [**REQUISITOS PRIORIZACIÓN.pdf**](https://github.com/jhoanapechram/-FIS-Equipo-2/blob/Primera-Entrega/1era%20Entrega/Requisitos/REQUISITOS%20PRIORIZACI%C3%93N.pdf) | El siguiente documento contiene la priorización de requisitos funcionales del sistema de la aplicación SmartPrice, utilizando el método MoSCoW.
