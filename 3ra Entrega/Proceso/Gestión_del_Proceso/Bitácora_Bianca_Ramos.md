# Bitácora Personal – Tercera Entrega  
**Integrante:** Bianca Sofia Ramos Chel  
...
- También llevé a cabo la nueva priorización de los requisitos, ya que había algunos que no se podían adaptar completamente a la app y fue necesario reorganizarlos para mantener coherencia con los objetivos del proyecto.
...
- Además, elaboré la bitácora final correspondiente al último sprint de esta tercera entrega, destacando de manera organizada todas las actividades realizadas y los resultados obtenidos, con el fin de dejar un registro claro del proceso rumbo a la entrega final del proyecto.
