...
| Crear un artefacto que permita al usuario realizar una tarea real y documentar sus dificultades o comentarios durante la interacción. | Bianca Ramos (define la tarea a simular), Ana Angulo (elabora las instrucciones para la interacción del usuario), Alejandra Aguilar (diseña la herramienta tipo formulario para capturar respuestas y observaciones). | `Simulacion_TareaUsuario.md` |
