...
7. [Secciones del prototipo](#️-secciones-del-prototipo)
   - [7.1 Página de Inicio](#71-página-de-inicio)
   - [7.2 Login y Registro](#72-sección-de-login-y-registro)
   - [7.3 Búsqueda de Productos](#73-sección-de-búsqueda-de-productos)
   - [7.4 Comparar Precios](#74-sección-de-comparar-precios)
   - [7.5 Carrito de Compras](#75-sección-del-carrito-de-compras)
   - [7.6 Mapa de Tiendas](#76-sección-del-mapa-de-tiendas)
   - [7.7 Perfil del Usuario](#77-sección-del-perfil-del-usuario)
   - [7.8 Chat o Asistencia](#78-sección-de-chat-o-asistencia)
...
*(Se sugiere insertar un diagrama del flujo con flechas y pantallas conectadas.)*
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Inicio.png`
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Login.png`

---

### **7.3 Sección de Búsqueda de Productos**
**Objetivo:** Facilitar la búsqueda de productos específicos.  
**Elementos:**
- Barra de búsqueda  
- Ícono de lupa  
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Busqueda.png`

---

### **7.4 Sección de Comparar Precios**
**Objetivo:** Mostrar una tabla comparativa de precios por tienda.  
**Elementos:**
- Tabla con nombre de tienda, precio y logo  
- Botón “Agregar al carrito”  
- Resaltado del precio más bajo  
**Función:** Simula la comparación de precios visual.  
📸 *Captura sugerida:* `Mockup_SmartPrice_Comparar.png`

---

### **7.5 Sección del Carrito de Compras**
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Carrito.png`

---

### **7.6 Sección del Mapa de Tiendas**
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Mapa.png`

---

### **7.7 Sección del Perfil del Usuario**
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Perfil.png`

---

### **7.8 Sección de Chat o Asistencia**
...
📸 *Captura sugerida:* `Mockup_SmartPrice_Chat.png`
